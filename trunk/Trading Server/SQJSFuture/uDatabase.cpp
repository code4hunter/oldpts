...
// 连接数据库
void db::connect(const std::string &dbname)
{
	filename = dbname;
...
long db::add_order(CThostFtdcOrderField *pOrder)
{
}

void db::update_order(CThostFtdcOrderField *pOrder)
{
}

void db::add_trade(CThostFtdcTradeField *pTrade)
{
}

void db::update_account(CThostFtdcTradingAccountField *pTradingAccount)
{
}

void db::update_position(CThostFtdcInvestorPositionField *pInvestorPosition)
{
}

int db::qry_order_by_ordid(const std::string &investorId,const std::string &id,
           CThostFtdcOrderField &ord)
{
}

int db::qry_orders(const std::string &investorId,
...
int db::qry_trade_by_ordid(const std::string &investorId,const std::string &id,
		   std::vector<CThostFtdcTradeField> &list)
{
}

int db::qry_trades(const std::string &investorId,
		   const std::string seqnum,
		   long maxrec,
		   std::vector<CThostFtdcTradeField> &list)
{
...
int db::qry_positions(const std::string &investorId,
		   std::vector<CThostFtdcInvestorPositionField> &list)
{
}

int db::qry_account(const std::string &investorId,
