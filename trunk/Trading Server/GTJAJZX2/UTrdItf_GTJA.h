//---------------------------------------------------------------------------
#ifndef UTrdItf_GTJAH
#define UTrdItf_GTJAH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TTrdItf_GTJA : public TTrdItfBase
{
public:
	typedef struct
	{
...
private:
	...
	AnsiString FOrderDate;
	AnsiString FAccountType;
...
public:		// User declarations
	TTrdItf_GTJA(const char *psetupfile,ADDLOG plogfunc,bool createKeeper);
	virtual  ~TTrdItf_GTJA();
};
