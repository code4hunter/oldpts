...
// *********************************************************************//
const GUID LIBID_HsCommX = {0x5DD0C266, 0x258A, 0x49C6,{ 0x8A, 0x41, 0x82,0x25, 0x6F, 0xD3,0x08, 0xDD} };
const GUID IID_IComm = {0xD9314C0B, 0x4317, 0x4C15,{ 0x8B, 0x0E, 0x04,0x4D, 0x5C, 0x49,0x3B, 0x7A} };
const GUID CLSID_Comm = {0x8767CA4F, 0x4787, 0x4327,{ 0x99, 0xC8, 0x77,0x32, 0x44, 0xF9,0x96, 0x1F} };
