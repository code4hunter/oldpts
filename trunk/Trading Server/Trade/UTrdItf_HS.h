...
////////////////////////////////////////////////////////////////////////////
class TTrdItf_HS : public TTrdItfBase
{
public:
  typedef struct
  {
    ...
    char  op_station[13];   //操作站点/电话号码    MAC
    char  op_entrust_way;   //操作委托方式         t_entrust_way
    short branch_no;        //营业部号             0000
    //char  input_content;    //输入方法  '1'=资金帐号
    //char  content_type;     //客户标识类型 '0'
    //char  account_content[30]; //客户标识
    //char  password[10];     //密文口令
    bool  is_gtja;
  } THSSet;
...
public:		// User declarations
   TTrdItf_HS(THSSet *set);
  virtual  ~TTrdItf_HS();

  static bool RegHsCommX(String PathName);
  static bool SetupHsCommX(void);
