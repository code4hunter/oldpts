...
#define IContractDetails_get_tradingClass(This,pVal)	\
...
/* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE IContractDetails_get_tradingClass_Proxy( 
    IContractDetails * This,
    /* [retval][out] */ BSTR *pVal);


void __RPC_STUB IContractDetails_get_tradingClass_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
