...
public:
  ...
  __property   BSTR            Buffer = {read = get_Buffer, write = set_Buffer};
...
{
  BSTR value = 0;
  OLECHECK(this->FieldByName(FieldName/*[in]*/, (BSTR*)&value));
  return value;
}
...
{
  long valu;
  OLECHECK(this->SendBuffer(value/*[in]*/, (long*)&valu));
  return valu;
}
...
{
  long value;
  OLECHECK(this->ConnectX(Protocol/*[in]*/, Address/*[in]*/, Port/*[in]*/, KeyCipher/*[in]*/, 
                          Key/*[in]*/, KeyLen/*[in]*/, (long*)&value));
  return value;
}
...
{
  BSTR value = 0;
  OLECHECK(this->GetFieldName(Index/*[in]*/, (BSTR*)&value));
  return value;
}
