...
class JsdGateway:public TError
{
private:
...
public:
  ...
  */
	bool WaitAnswer(const char *request,int fieldCount,bool singlerecord=true,int countOffset=2);
